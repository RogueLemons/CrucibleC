...
bool PrefixNamespaceRule::isThirdParty(const std::string &path) const {
...
bool PrefixNamespaceRule::isHeaderFile(const std::string &path) const {
...
std::string PrefixNamespaceRule::upper(const std::string &s) const {
    std::string out = s;
...
std::vector<std::string> PrefixNamespaceRule::splitPath(
...
std::vector<std::string> PrefixNamespaceRule::extractDirs(
    const std::string &path) const {
...
std::string PrefixNamespaceRule::buildPrefix(
    const std::string &path) const {
...
std::string PrefixNamespaceRule::buildIncludeGuardName(
    const std::string &path) const {
...
bool PrefixNamespaceRule::shouldCheckPath(
    const std::string &path) const {
...
void PrefixNamespaceRule::checkName(SourceManager &sm,
               SourceLocation loc,
...
void PrefixNamespaceRule::checkIncludeGuard(SourceManager &sm,
                       SourceLocation loc,
                       const std::string &path) {
...
void PrefixNamespaceRule::checkFileIncludeGuard(SourceManager &sm,
                           SourceLocation loc,
                           const std::string &path) {
...
PrefixNamespaceRule::PrefixNamespaceRule(
    const Config &cfg,
...
void PrefixNamespaceRule::bindFinder(MatchFinder &finder) {
    finder.addMatcher(
        functionDecl(
